##########
# Windows 10 (v1507 - v21H2) / Server 2016 / Server 2019 / Server 2022 Initial Setup Script - Tweak Library
# Author: Disassembler <disassembler@dasm.cz>
# Maintainer: Pontus Öwre <pontus@owre.se>, DevGrx
# Version: v3.2, 2021-10-28
...
# Disable automatic updates for UWP apps
Function DisableUWPAutomaticUpdates {
	Write-Output "Disabling Automatic Updates for UWP apps..."
...
# Enable automatic updates for UWP apps
Function DisableUWPAutomaticUpdates {
	Write-Output "Disabling Automatic Updates for UWP apps..."
	If (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore")) {
		New-Item -Path "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore" -Force | Out-Null
	}
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore" "AutoDownload" 4
}
...
# The tweak is slightly experimental, as it registers a dummy debugger for MusNotification.exe which blocks the restart prompt executable from running, thus never scheduling the restart.
...
# Hide People icon from taskbar - Applicable since 1803
...
# Show People icon on taskbar - Applicable since 1803
...
# Show Meet Now tray icon - Applicable since 20H2
...
# Hide Meet Now tray icon - Applicable since 20H2
...
# Disable News and Interests - Fully applicable since 21H1 (Since 1909 only with latest updates installed)
...
# Enable News and Interests - Fully applicable since 21H1 (Since 1909 only with latest updates installed)
...
Function SetAppsDarkMode {
	...
	Set-ItemProperty -Path "HKU:\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "AppsUseLightTheme" -Type DWord -Value 0
}
...
Function SetAppsLightMode {
	...
	Set-ItemProperty -Path "HKU:\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "AppsUseLightTheme" -Type DWord -Value 1
}
...
Function SetSystemLightMode {
	...
	Set-ItemProperty -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "SystemUsesLightTheme" -Type DWord -Value 1
	Set-ItemProperty -Path "HKU:\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "SystemUsesLightTheme" -Type DWord -Value 1
}
...
Function SetSystemDarkMode {
	...
	Set-ItemProperty -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "SystemUsesLightTheme" -Type DWord -Value 0
	Set-ItemProperty -Path "HKU:\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize" -Name "SystemUsesLightTheme" -Type DWord -Value 0
}
...
Function UninstallMsftBloat {
	...
	### Optional ###
	# Get-AppxPackage "Microsoft.Advertising.Xaml" | Remove-AppxPackage # Dependency for Microsoft.WindowsCommunicationsApps and Microsoft.BingWeather
...
Function InstallMsftBloat {
	...
	### Optional (if not uninstalled) ###
	Get-AppxPackage -AllUsers "Microsoft.Advertising.Xaml" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"} # Dependency for Microsoft.WindowsCommunicationsApps and Microsoft.BingWeather
...
Function InstallThirdPartyBloat {
	...
	Get-AppxPackage -AllUsers "2FE3CB00.PicsArt-PhotoStudio" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "613EBCEA.PolarrPhotoEditorAcademicEdition" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "6Wunderkinder.Wunderlist" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "ClearChannelRadioDigital.iHeartRadio" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "Flipboard.Flipboard" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "Playtika.CaesarsSlotsFreeCasino" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "ShazamEntertainmentLtd.Shazam" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	Get-AppxPackage -AllUsers "SlingTVLLC.SlingTV" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "TheNewYorkTimes.NYTCrossword" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
	...
	Get-AppxPackage -AllUsers "TuneIn.TuneInRadio" | ForEach-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
...
# Note: Adobe Flash is removed since 21H1.
...
# Disable Edge preload after Windows startup - Applicable since 1809
...
# Enable Edge preload after Windows startup - Applicable since 1809
...
# PowerShell 2.0 is deprecated since September 2017. This doesn't affect PowerShell 5 or newer which is the default PowerShell environment.
...
# Split svchost.exe processes threshold
# Note: This function has no counterpart.
Function SplitSvcHostThreshold {
	$ram = (Get-CimInstance -ClassName Win32_PhysicalMemory | Measure-Object -Property Capacity -Sum).Sum / 1kb
	Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control" -Name "SvcHostSplitThresholdInKB" -Type DWord -Value $ram -Force
}

# Remove leftover registry keys of uninstalled UWP apps if they exist
# Note: This function has no counterpart.
Function RemoveUWPRegKeys {
    $Keys = @(
...
Function WindowsUpdateFix {
    ...
    Write-Host "Renaming the SoftwareDistribution and CatRoot Folder..." 
